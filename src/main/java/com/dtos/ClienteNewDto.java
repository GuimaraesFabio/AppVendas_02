...
import com.services.validation.ClienteInsert;
...
public class ClienteNewDto implements Serializable {
	...
	@NotEmpty(message = "Campo logradouro não pode ser vazio/nulo.")
	private String logradouro;
	private String numero;
	@NotEmpty(message = "Campo complemento não pode ser vazio/nulo.")
	private String complemento;
	private String bairro;
	@NotEmpty(message = "Campo cep não pode ser vazio/nulo.")
	private String cep;

	@NotEmpty(message = "Campo telefone não pode ser vazio/nulo.")
