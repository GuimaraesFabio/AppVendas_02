...
import com.controllers.utils.URL;
...
public class ProdutoController {
	...
	public ResponseEntity<Page<ProdutoDto>> search(@RequestParam(value = "nome", defaultValue = "") String nome,
		...
		String nomDeCode = URL.decodeParam(nome);
		List<Integer> ids = URL.listToInt(categorias);
		Page<Produto> list = _service.search(nomDeCode, ids, page, linePerPage, direction, orderBy);
